...
import io.github.cyfko.jpa.metamodel.providers.PersistenceMetadataRegistryProvider;
 ...
 * {@code io.github.cyfko.jpa.metamodel.providers.PersistenceMetadataRegistryProviderImpl}.
 * </p>
 *
 * <p>
 * Typical usage:
    ...
    private static PersistenceMetadataRegistryProvider loadProvider() {
        try {
            Class<?> registryClass = Class.forName(
                    "io.github.cyfko.jpa.metamodel.providers.PersistenceMetadataRegistryProviderImpl"
            );
