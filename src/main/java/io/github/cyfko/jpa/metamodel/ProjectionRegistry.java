...
import io.github.cyfko.jpa.metamodel.model.projection.ComputationProvider;
...
import io.github.cyfko.jpa.metamodel.providers.ProjectionMetadataRegistryProvider;
...
public final class ProjectionRegistry {
     ...
     * <p>
     * Attempts to instantiate {@code io.github.cyfko.jpa.metamodel.providers.ProjectionMetadataRegistryProviderImpl}
    ...
    private static ProjectionMetadataRegistryProvider loadProvider() {
        try {
            Class<?> registryClass = Class.forName(
                    "io.github.cyfko.jpa.metamodel.providers.ProjectionMetadataRegistryProviderImpl"
            );
