 ...
 * {@code io.github.cyfko.filterql.jpa.metamodel.providers.PersistenceMetadataRegistryProviderImpl}.
 * </p>
 *
 * <p>
 * Typical usage:
    ...
    private static PersistenceMetadataRegistryProvider loadProvider() {
        try {
            Class<?> registryClass = Class.forName(
                    "io.github.cyfko.filterql.jpa.metamodel.providers.PersistenceMetadataRegistryProviderImpl"
            );
