...
public class EntityProcessor {
    ...
    public void generateProviderImpl() {
        ...
        try {
            JavaFileObject file = processingEnv.getFiler()
                    .createSourceFile("io.github.cyfko.filterql.jpa.metamodel.providers.PersistenceMetadataRegistryProviderImpl");
    ...
    private void writeEntityRegistry(Writer writer) throws IOException {
        ...
        writer.write("import io.github.cyfko.filterql.jpa.metamodel.model.PersistenceMetadata;\n");
        ...
        writer.write("import io.github.cyfko.filterql.jpa.metamodel.model.CollectionMetadata;\n");
