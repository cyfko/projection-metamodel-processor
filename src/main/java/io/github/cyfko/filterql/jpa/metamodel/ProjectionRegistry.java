...
public final class ProjectionRegistry {
     ...
     * <p>
     * Attempts to instantiate {@code io.github.cyfko.filterql.jpa.metamodel.providers.ProjectionMetadataRegistryProviderImpl}
    ...
    private static ProjectionMetadataRegistryProvider loadProvider() {
        try {
            Class<?> registryClass = Class.forName(
                    "io.github.cyfko.filterql.jpa.metamodel.providers.ProjectionMetadataRegistryProviderImpl"
            );
